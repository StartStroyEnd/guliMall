  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ deafultAddress.userAddress }}</span>
        收货人：<span>{{ deafultAddress.consignee }}</span>
        <span>{{ deafultAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 不使用uvex直接发送请求。
    // 需要将接口函数添加到Vue的原型对象上面去main.js
    async submitOrder() {
      let tradeNo = this.tradeInfo.tradeNo;
      // 创建模板容器接收返回数据
      let tradeInfo = {
        consignee: this.deafultAddress.consignee,
        consigneeTel: this.deafultAddress.phoneNum,
        deliveryAddress: this.deafultAddress.userAddress,
        paymentWay: "ONLINE",
